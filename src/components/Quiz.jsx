...
const Quiz = () => {
  ...
  const traitToTail = {
    strong: "Clubtail",
    agile: "Daggertail", // or Swordtail depending on how you want to weight them
    deadly: "Scorpiontail",
    cunning: "Swordtail", // optionally associate more
    bold: "Daggertail"
    // add more here!!!!!
  };
  ...
  const calculateResult = () => {
    ...
    // Helper function to find the most frequent entry
  ...
  return (
    <div className="container">
      {showResult ? (
        ...
        <motion.div
          key={currentQuestionIndex} // Key to force remounting for each question
